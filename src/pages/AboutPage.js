...
function AboutPage() {
    ...
    <div class="center-container">
        ...
        <article class="container">
            ...
            <p>
                Initially trained in biochemistry, I'm currently studying computer science to pursue software engineering. I have interest in full stack development, data science, and dev ops.
                This site is continuously deployed on Netlify and I am exploring building robust CI/CD pipelines.
                I am also studying for the AWS Solutions Architect certification and learning to applying Terraform as an IaC solution.
                <br></br><br></br>
